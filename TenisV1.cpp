...
bool JuegoAleatorio = false, Victoria1 = false, Victoria2 = false, GanarPunto = false, ModoDebug = true;
		...
		if (ModoDebug == false) {
				...
				if (num == 0) {
					...
					if ((PosicionBola < 1) || (PosicionBola > 7)) {
						...
						cout << "Punto para " << NombreTenista2 << endl;
					...
					if ((PosicionTenista2 != PosicionBola) && ((PosicionBola >= 1) && (PosicionBola <= 7))) {
						...
						cout << "Punto para " << NombreTenista1 << endl;
				...
				if (GanarPunto == true) {
					...
					if ((Puntuacion1 == 4) && (Puntuacion2 == 4)) {
